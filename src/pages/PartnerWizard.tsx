        ...
        <Card className="shadow-soft animate-scale-in">
          <CardHeader>
            ...
            <CardDescription>
              ...
              {currentStep === 2 && "How do they receive love?"}
              {currentStep === 3 && "Optional contact information"}
              {currentStep === 4 && "Private notes for your eyes only"}
            </CardDescription>
          </CardHeader>
            ...
            {currentStep === 3 && (
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="chatHistory"
                    placeholder="Paste important chat logs or messages here..."
                    value={chatHistory}
            ...
            {currentStep === 4 && (
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="notes"
                    placeholder="Any special notes, reminders, or things to remember..."
                    value={notes}

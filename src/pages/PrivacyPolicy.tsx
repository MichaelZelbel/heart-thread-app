...
const PrivacyPolicy = () => {
  useEffect(() => {
    document.title = "Privacy Policy - Cherishly";
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <main className="flex-1 prose prose-slate dark:prose-invert max-w-none">
              ...
              <div className="print-only mb-8">
                <h1 className="text-3xl font-bold">Privacy Policy - Cherishly</h1>
              ...
              <p>
                For more information about the cookies we use and your choices regarding cookies, please visit our <Link to="/cookies">Cookies Policy</Link>.
              </p>
              ...
              <div className="mt-12 pt-8 border-t text-sm text-muted-foreground not-prose">
                <p>
                  See also: <Link to="/terms" className="underline hover:text-foreground">Terms of Service</Link> | <Link to="/cookies" className="underline hover:text-foreground">Cookies Policy</Link>
                </p>
              </div>
            </main>
          </div>

...
const TermsOfService = () => {
  useEffect(() => {
    document.title = "Terms of Service - Cherishly";
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <main className="flex-1 prose prose-slate dark:prose-invert max-w-none">
              ...
              <div className="print-only mb-8">
                <h1 className="text-3xl font-bold">Terms of Service - Cherishly</h1>
              ...
              <p>
                Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy of the Company. Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal information when You use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our <Link to="/privacy">Privacy Policy</Link> carefully before using Our Service.
              </p>
              ...
              <h2 id="disclaimer">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
              ...
              <h2 id="disputes">Disputes Resolution</h2>
              ...
              <h2 id="changes">Changes to These Terms and Conditions</h2>
              ...
              <div className="mt-12 pt-8 border-t text-sm text-muted-foreground not-prose">
                <p>
                  See also: <Link to="/privacy" className="underline hover:text-foreground">Privacy Policy</Link> | <Link to="/cookies" className="underline hover:text-foreground">Cookies Policy</Link>
                </p>
              </div>
            </main>
          </div>

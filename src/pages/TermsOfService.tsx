...
const TermsOfService = () => {
  return (
    <LegalPageLayout
      ...
      seoTitle="Terms of Service | Cherishly"
      seoDescription="Read Cherishly's terms of service — the agreement governing your use of our platform."
      lastUpdated="October 9, 2025"
      sections={sections}
      footer={
        <div className="mt-12 pt-8 border-t text-sm text-muted-foreground">
          <p>
            See also: <Link to="/privacy">Privacy Policy</Link> | <Link to="/cookies">Cookies Policy</Link>
          </p>
        </div>
      }
    >
